...
const RightpanelContainer = () => {
  ...
  const handlehover = () => {
    let heartempty = document.querySelector(".heart-empty");
    let heartfilled = document.querySelector(".heart-fill");
    heartfilled.classList.add("visible-icon");
    heartfilled.classList.remove("hide");
    heartempty.classList.add("hide");
  };
  const handleClick = () => {
    let heartempty = document.querySelector(".heart-empty");
    let heartfilled = document.querySelector(".heart-fill");
    heartfilled.classList.add("green");
    heartfilled.classList.remove("hide");
    heartempty.classList.add("hide");
  };
  const handleMouseLeave = () => {
    let heartempty = document.querySelector(".heart-empty");
    let heartfilled = document.querySelector(".heart-fill");
    heartfilled.classList.remove("visible-icon");
    heartfilled.classList.add("hide");
    ...
    <div className="body-container__right">
      <div className="product-info">
        <div className="product-name__container">
          ...
          <div onClick={handleClick} className="heart-icon__container">
            <BiHeart className="heart-icon heart-empty" />
            <FaHeart className="heart-icon heart-fill hide" />
          </div>
        </div>
        ...
        <div className="product-other-info">
          ...
          <div className="inner-flex-container">
            <div className="inner-flex-item-11">Home Delivery - $ 10</div>
            <div className="inner-flex-item-2 div-position">
              <BiChevronRight className="color-grey" />
            </div>
          </div>
          <hr className="position-hr  d1 color-hr" />
        </div>
      </div>
    </div>
  );
